...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 sm:py-28 bg-gray-50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold mt-2 mb-4">Book Your Cleaning Service</h2>
            <p className="text-gray-500 text-lg mb-10">
              Fill out the form and our team will get back to you within 30 minutes. Or reach us directly.
            </p>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={item.label} className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-primary-50 rounded-xl flex items-center justify-center text-primary shrink-0">
                    {item.icon}
                  </div>
                  <div>
          ...
          >
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-6">
                <button
                  type="submit"
                  className="flex-1 bg-primary hover:bg-primary-dark text-white px-6 py-3.5 rounded-xl font-semibold transition-all hover:shadow-lg hover:shadow-primary/25 text-sm"
                >
                  Book Appointment
                </button>
                <a
                  ...
                  className="flex-1 bg-whatsapp hover:brightness-110 text-white px-6 py-3.5 rounded-xl font-semibold transition-all text-sm flex items-center justify-center gap-2"
                >
