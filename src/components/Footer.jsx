      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold">
                Clean<span className="text-primary-light">Pro</span>
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {['Home Cleaning', 'Pool Cleaning', 'Tank Cleaning', 'Villa Cleaning', 'Pest Control', 'Carpet Cleaning'].map((service) => (
                <li key={service}>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} CleanPro Hail. All rights reserved.
          </p>
